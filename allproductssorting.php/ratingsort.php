    ...
    <div class="small_container">
        ...
        <div class="row">
            ...
            FROM `allbeers` 
                ...
                LEFT JOIN `ratings` ON `allbeers`.`overall` = `ratings`.`rating_id` ORDER BY overall DESC LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
        ...
        <div class="row">
            <span class="page-btn">
                <a href="ratingsort.php?page=<?= $Previous; ?>" aria-label="Previous">
                    <span aria-hidden="true">Previous &laquo; </span>
                </a>
                <?php
                for ($i = 1; $i <= $page; $i++) : ?>
                    <a class="page-btn" href="ratingsort.php?page=<?= $i; ?>"><?= $i; ?></a>
                <?php endfor; ?>

                <a class="page-btn" href="ratingsort.php?page=<?= $Next; ?>" aria-label="Next">
