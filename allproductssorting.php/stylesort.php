...
<body>
    ...
    <div class="small_container">
        ...
        <div class="row">
            ...
            $this_page_first_result = ($page - 1) * $results_per_page;
                ...
                FROM `allbeers` 
                    ...
                    LEFT JOIN `ratings` ON `allbeers`.`overall` = `ratings`.`rating_id` ORDER BY beerstyle LIMIT '. $this_page_first_result . ',' .  $results_per_page;
        ...
        <div class="row">
            <span class="page-btn">
                <a href="stylesort.php?page=<?= $Previous; ?>" aria-label="Previous">
                    <span aria-hidden="true">Previous &laquo; </span>
                </a>
                <?php
                for ($i = 1; $i <= $page; $i++) : ?>
                    <a class="page-btn" href="stylesort.php?page=<?= $i; ?>"><?= $i; ?></a>
                <?php endfor; ?>

                <a class="page-btn" href="stylesort.php?page=<?= $Next; ?>" aria-label="Next">
