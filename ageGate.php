...
<body>
    ...
    <div class="account-page">
        <h2 class="title">Age Verification</h2>
        <div class="container">
            <div class="row">
                <div class="col-2">
                    <div class="form-container" style="top:75px">
                        <form action="includes\ageverification.php" id="RegForm" method="post">
                            
                            <input type="number" name="userAge" min="1" max="100" placeholder="Please Enter Your Age!">
                            <button type="submit" name="ageVbtn" class="btn"> Confirm </button>
