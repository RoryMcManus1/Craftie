...
<body>
    ...
    <!---------------------------- New Password Page ------------------------------------------------>
            ...
            <h2 class="title">Account Removal</h2>
                <div class="container">
                    <div class="row">
                        <div class="col-2">
                            <div class="form-container" style="top:75px">
                                <form action="includes\deleteaccount.php" id="RegForm" method="post">
                                <h4>Are you sure you would like to remove your account? All account data will be lost forever!</h4>
                                    <button type="submit" name="deleteConfirm" class="btn"> Yes I'm sure! </button>
                                </form>
                            </div>
                        </div>
                    </div>
